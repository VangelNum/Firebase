...
sealed class DrawerAnotherApplications(@StringRes val title: Int, val icon: Int) {
    object SoundBoard : DrawerAnotherApplications(R.string.zxcursed_soundboard, R.drawable.soundboard)
    object DrumPad : DrawerAnotherApplications(R.string.zxcursed_drumpad, R.drawable.drumpad)
}
